...
namespace FilmFranchiseAPI.Services.Security
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, IOptions<IdentityOptions> optionsAccessor)
        {
        ...
        public async Task<UserManagerResponse> LoginUserAsync(LoginViewModel model)
        {
            ...
            var claims = new List<Claim>()
            {
                ...
                new Claim(this._idOpts.ClaimsIdentity.UserIdClaimType, user.Id)
            };
